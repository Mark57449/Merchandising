...
// ** Configurações do MySQL - Você pode pegar estas informações a
// com o serviço de hospedagem ** //

/** Configuração Adicional: Permite instalar plugins Localhost */
define('WP_CACHE', true);
define( 'WPCACHEHOME', 'C:\xampp\htdocs\Geekko_WC\wp-content\plugins\wp-super-cache/' );
define( 'FS_METHOD', 'direct' );

/** O nome do banco de dados do WordPress */
define( 'DB_NAME', 'geekko_wcbd' );
